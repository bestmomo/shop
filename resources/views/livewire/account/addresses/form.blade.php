<x-form wire:submit="save" class="w-full sm:min-w-[50vw]">
    ...
    <x-input label="{{ __('Street number and name') }}" type="text" wire:model="address" icon="o-home" required />
    <x-input label="{{ __('Building') }}" type="text" hint="{{ __('Optional') }}" wire:model="addressbis" icon="o-home" />
    <x-input label="{{ __('Place name or PO') }}" type="text" hint="{{ __('Optional') }}" wire:model="bp" icon="c-map-pin" />
